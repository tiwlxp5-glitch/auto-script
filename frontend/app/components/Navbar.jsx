        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              {user ? (
                <>
                  <Link to="/pricing" className="group flex items-center bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 text-amber-700 hover:border-amber-300 hover:shadow-md px-4 py-1.5 rounded-full font-bold text-sm transition-all cursor-pointer shadow-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 mr-1.5 text-amber-500 group-hover:scale-110 transition-transform">
