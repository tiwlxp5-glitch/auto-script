...
function Register() {
  ...
  const handleResendVerification = async () => {
    ...
    if (error) {
      ...
      toast.success('ส่งอีเมลยืนยันตัวตนใหม่อีกครั้งแล้ว กรุณาเช็คกล่องข้อความของคุณ', {
    ...
    <>
      ...
      {success ? (
        ...
        <>
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">รหัสผ่าน (ขั้นต่ำ 8 ตัวอักษร)</label>
