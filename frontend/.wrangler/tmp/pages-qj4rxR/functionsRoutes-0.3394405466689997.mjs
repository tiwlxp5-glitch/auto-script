...
import { onRequestPost as __api_generate_backup_js_onRequestPost } from "C:\\Auto script\\frontend\\functions\\api\\generate.backup.js"
...
export const routes = [
  ...
  {
      routePath: "/api/generate.backup",
      mountPath: "/api",
      method: "POST",
      middlewares: [],
      modules: [__api_generate_backup_js_onRequestPost],
    },
  {
