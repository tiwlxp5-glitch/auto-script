...
function CreateScript() {
  ...
  const tones = [
    { id: 'ผู้หญิง', label: 'ผู้หญิง', desc: '(ค่ะ, คะ, ฉัน)', icon: <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7a4 4 0 1 1 8 0c0 2-1 3.5-1 5a3 3 0 0 1-6 0c0-1.5-1-3-1-5z M12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg> },
